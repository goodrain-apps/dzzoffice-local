...
$_config['memory']['redis']['server'] = getenv("REDIS_HOST")?getenv("REDIS_HOST"):"";
$_config['memory']['redis']['port'] = getenv("REDIS_PORT")?getenv("REDIS_PORT"):6379;
...
$_config['memory']['memcache']['server'] = getenv("MEMCACHE_HOST")?getenv("MEMCACHE_HOST"):'127.0.0.1'; // memcache 服务器地址
$_config['memory']['memcache']['port'] = getenv("MEMCACHE_PORT")?getenv("MEMCACHE_PORT"):11211;			// memcache 服务器端口
